...
public class CustomerBillingSteps extends Testbase {
    ...
    public void userEntersAllDetailsInCustomerBillingPageAndWorkflow() throws InterruptedException, IOException {
    ...
    public void userGoToBillReviewPageAndSerachForBillBatch() throws InterruptedException {
        ...
        customerBillingPage = new CustomerBillingPage();
        //customerBillingPage.cleartheBillStatus();
    ...
    public void userGoToCustomerBillingPageAndSerachForBillBatch() throws InterruptedException {
        homePage = new HomePage();
        homePage.searchforCustomerBilling();
        customerBillingPage.enterBillBatchNumber(BillBatchNO);
        customerBillingPage.clickonBillBatchLink();
    ...
    public void userApproveTheBillBatch() throws InterruptedException {
        workOrderPage = new WorkOrderPage();
    ...
    public void userOpensTheBatchAndWorkflow() throws InterruptedException {
        workOrderPage = new WorkOrderPage();
        //workOrderPage.clickonOKbutton();
        workOrderPage.clickonWorkflowButton();
    }
    ...
    public void userVerifiesChangesTheBillBatchStatusToApprovedByCustomer() throws InterruptedException {
        customerBillingPage = new CustomerBillingPage();
        customerBillingPage.ClickonChangeStatusButton();
        customerBillingPage.selecttheNewStatus();
    }

    @And("^user verifies that the Bill batch status changes to Posted$")
    public void userVerifiesThatTheBillBatchStatusChangesToPosted() throws InterruptedException {
        homePage = new HomePage();
        homePage.searchforCustomerBilling();
        customerBillingPage.enterBillBatchNumber(BillBatchNO);
        customerBillingPage.clickonBillBatchLink();
