...
public class FMRCreationSteps extends ForwardMainteananceRegisterPage {
    ...
    public void userClicksOnSaveButton() throws InterruptedException {
        ...
        //forwardMainteananceRegisterPage.ClickonYesButton();
    ...
    public void userClickOnMoveToQuationButton() throws InterruptedException {
        forwardMainteananceRegisterPage = new ForwardMainteananceRegisterPage();
    ...
    public void theFMRStatusChangeToApprovedFromWAPPR() throws InterruptedException, IOException {
    ...
    public void aNewQuoteCreatedUnderAssociatedQuotesSection() throws IOException, InterruptedException {
        forwardMainteananceRegisterPage.CopyQuoteNumber();
        forwardMainteananceRegisterPage.ClickonOKbutton();
