...
public class PurchaseOrderLinesPage extends WorkOrderPage {
    ...
    @FindBy(xpath = "//*[@id='mf9bb799f_tdrow_[C:0]_tbselrow-ti[R:0]_img']")
    WebElement POcheckbox;
    @FindBy(xpath = "//*[@id='mab71af75-pb']")
    WebElement OK;
    ...
    public void AddLineDescription() throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, 60);
        wait.until(ExpectedConditions.elementToBeClickable(LineDescription)).sendKeys(" SmokeTest");
        // nameField.sendKeys(Name);
        sleep(1000);
    ...
    public void LinkWorkOrderNumber() throws InterruptedException, IOException {
        Thread.sleep(2000);
        FileReader FR = new FileReader("C:\\Users\\dmarella\\IdeaProjects\\AutomatioTest\\WO.txt");
    ...
    public static String verifythestatusofPO() throws IOException {
        ...
        File file = new File("C:\\Users\\dmarella\\IdeaProjects\\AutomatioTest\\SmokeTest_PRD40_Results.txt");
        if (!file.exists()) {
            file.createNewFile();
        }
        ...
        // BW.write("...Test..");
        BW.newLine();
        BW.write( "PurchaseOrder is:" + PO); // Writing In To File.
        BW.close();
        return PO;
