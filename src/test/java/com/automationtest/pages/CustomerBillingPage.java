...
public class CustomerBillingPage extends WorkOrderPage {
    ...
    public static String CopyBillBatchNumber() throws IOException, InterruptedException {
        Thread.sleep(2000);
        BillBatchNO = BillBatchNumberField.getAttribute("value");
        System.out.println("BillBatch Number is :" + BillBatchNO);
        File file = new File("C:\\Users\\dmarella\\IdeaProjects\\AutomatioTest\\SmokeTest_PRD40_Results");
        if (!file.exists()) {
            file.createNewFile();
        }
