...
public class WorkOrderPage extends PreventiveMaintenancePage {
    ...
    static String WOFILE = " C:\\Users\\dmarella\\IdeaProjects\\AutomatioTest\\WO.txt";
    ...
    public static String CopyWorkOrderNumber() throws IOException {
        ...
        File FC = new File("C:\\Users\\dmarella\\IdeaProjects\\AutomatioTest\\WO.txt");
        FC.createNewFile();
        // Writing in to File
        FileWriter FW = new FileWriter("C:\\Users\\dmarella\\IdeaProjects\\AutomatioTest\\WO.txt");
    ...
    public void enterActualStartDate() throws InterruptedException {
        ...
        actions.sendKeys(ActualStartDateField, " 5/1/2020").perform();
