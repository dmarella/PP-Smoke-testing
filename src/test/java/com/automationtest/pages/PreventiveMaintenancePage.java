...
public class PreventiveMaintenancePage extends Testbase {
    ...
    @FindBy(xpath = "//button[@id='m88dbf6ce-pb' or @id='mc2853d87-pb']")
    WebElement OKbutton;
    ...
    public void searchPM() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public static String changeEstimatedNextDueDate() throws InterruptedException {
        Thread.sleep(3000);
    ...
    public void enterLabourNumber() throws InterruptedException {
       ...
       // wait.until(ExpectedConditions.elementToBeClickable(LabourField)).sendKeys("078476");
