...
public class PurchaseOrderPage extends Testbase {
    ...
    @FindBy(xpath = "//*[contains(text(), 'PHS COMPLIANCE LTD')]")
    WebElement PHSCOMPLIANCELTD;
    ...
    public void DescriptionFilling() {
       ...
       // String Datavalue = "Customer Support Training PO ‘APPR’ Service without Receipts";
        ...
        //String Datavalue = "CMDTraining PO waiting for Approval Status";
       // String Datavalue = "FA Training PO Material in Approval Status";
        //String Datavalue = "FA Training PO Material in WAPPR Status";
    ...
    public void VendorDetailsFilling(){
        ...
        SelectValueButton.click();
        WebDriverWait wait = new WebDriverWait(driver, 60);
        wait.until(ExpectedConditions.elementToBeClickable(PHSCOMPLIANCELTD));
        PHSCOMPLIANCELTD.click();
