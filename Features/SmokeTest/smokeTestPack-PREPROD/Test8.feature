...
Feature: SmokeTest
  ...
  Scenario: Creating an new ServiceRequest
    ...
    And user fill the new Service Request form
      ...
      | SmokeTest-8 | C1000011 | L1001455 | Test SR creation | REACTIVE \ BUILDING FABRIC \ GLAZING \ GLASSEXT | Test8   | 07776023458     | test@email.com  | CUST123           | CUST456            |
